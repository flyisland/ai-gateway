...
@description: API endpoint to begin a Duo Agent workflow for Chat. This test is being used for a stress test, and should not be de-quarantined.
@gpt_data_version: 1
...
export default function () {
  group("API - Duo Agent - Chat", function () {
    let params = {
      headers: {
    ...
    let body = {
      // This is expecting the Duo Workflow Test project to have been imported
