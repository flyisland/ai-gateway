...
## Graph: `developer_next/experimental` (Flow Registry)
...
graph TD;
    ...
    __start__ --> fix_pipeline_context;
    fix_pipeline_context(fix_pipeline_context<br>#91;AgentComponent#93;);
    fix_pipeline_next_decide_approach(fix_pipeline_next_decide_approach<br>#91;AgentComponent#93;);
    ...
    fix_pipeline_context --> fix_pipeline_next_decide_approach;
    fix_pipeline_next_decide_approach -.->|add_comment| fix_pipeline_add_comment;
    fix_pipeline_next_decide_approach -.->|create_plan| fix_pipeline_next_execution;
    fix_pipeline_next_decide_approach -.->|default_route| fix_pipeline_add_comment;
    fix_pipeline_add_comment --> __end__;
    fix_pipeline_next_execution --> fix_pipeline_next_decide_fix;
    fix_pipeline_next_decide_fix -.->|add_comment| fix_pipeline_add_comment;
    ...
    fix_pipeline_next_decide_fix -.->|default_route| fix_pipeline_add_comment;
    fix_pipeline_next_code_suggestions --> __end__;
    create_repository_branch --> fix_pipeline_git_commit;
    fix_pipeline_git_commit --> fix_pipeline_git_push;
...
graph TD;
    ...
    push_and_create_mr --> evaluate_merge_request;
