...
grpcurl -plaintext -d '{}' gdk.test:50052 DuoWorkflow/ListTools

This command will:

- Connect to the Duo Workflow service at `gdk.test:50052`
- Call the `ListTools` method
- Extract and format the tool name and description for each tool
