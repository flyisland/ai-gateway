...
We follow the [Semantic Versioning guideline](https://semver.org/). To harness the practice, we use [semantic-release](https://github.com/semantic-release/semantic-release).
