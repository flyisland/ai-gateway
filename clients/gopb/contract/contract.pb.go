...
type UiUpdate struct {
	...
	Status       string `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`
	ChatLogDelta string `protobuf:"bytes,2,opt,name=chat_log_delta,json=chatLogDelta,proto3" json:"chat_log_delta,omitempty"`
}
...
func (x *UiUpdate) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *UiUpdate) GetChatLogDelta() string {
	if x != nil {
		return x.ChatLogDelta
	}
	return ""
}
...
var file_contract_contract_proto_rawDesc = []byte{
	...
	0x0a, 0x09, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x48, 0x0a, 0x08, 0x55,
	0x69, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12,
	0x24, 0x0a, 0x0e, 0x63, 0x68, 0x61, 0x74, 0x5f, 0x6c, 0x6f, 0x67, 0x5f, 0x64, 0x65, 0x6c, 0x74,
	0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x63, 0x68, 0x61, 0x74, 0x4c, 0x6f, 0x67,
	0x44, 0x65, 0x6c, 0x74, 0x61, 0x2a, 0x7b, 0x0a, 0x12, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74,
	...
	0x10, 0x05, 0x32, 0x7b, 0x0a, 0x0b, 0x44, 0x75, 0x6f, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f,
...
var file_contract_contract_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
...
var file_contract_contract_proto_depIdxs = []int32{
	...
	24, // 7: HttpResponse.headers:type_name -> HttpResponse.HeadersEntry
	...
	1,  // 20: DuoWorkflow.ExecuteWorkflow:input_type -> ClientEvent
	13, // 21: DuoWorkflow.GenerateToken:input_type -> GenerateTokenRequest
	6,  // 22: DuoWorkflow.ExecuteWorkflow:output_type -> Action
	14, // 23: DuoWorkflow.GenerateToken:output_type -> GenerateTokenResponse
