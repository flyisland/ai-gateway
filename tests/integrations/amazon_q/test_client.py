...
class TestAmazonQClient:
    ...
    def test_delete_o_auth_app_connection_success(self, amazon_q_client: AmazonQClient):
        amazon_q_client.client.delete_o_auth_app_connection.side_effect = Mock()
        amazon_q_client.delete_o_auth_app_connection()
        amazon_q_client.client.delete_o_auth_app_connection.assert_called_once_with()
    ...
    def test_delete_o_auth_app_connection_on_conflict(
        ...
        amazon_q_client.client.delete_o_auth_app_connection.side_effect = ClientError(
    ...
    def test_delete_o_auth_app_connection_raises_non_conflict_aws_errors(
        ...
        amazon_q_client.client.delete_o_auth_app_connection.assert_called_once()
