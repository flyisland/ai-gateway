...
async def test_workflow_run_with_tools_registry(
    ...
    # Verify get_plan is called twice in planner setup
...
# The next two tests check that the tools defined in the agent setup methods in the workflow are actually in
