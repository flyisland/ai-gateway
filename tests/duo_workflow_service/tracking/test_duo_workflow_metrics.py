...
class TestDuoWorkflowMetrics(unittest.TestCase):
    ...
    @patch("lib.context.request_metadata.language_server_version")
    ...
    @patch("lib.context.request_metadata.gitlab_version")
    ...
    @patch("lib.context.request_metadata.client_type")
    ...
    @patch("lib.context.request_metadata.gitlab_realm")
    ...
    def test_count_response_schema_output(self):
        self._assert_counter_called(
            "agent_platform_response_schema_output_counter",
            "count_response_schema_output",
            {
                "flow_type": "fix_pipeline",
