...
class TestGenericGitLabAPITools:
    ...
    def test_generic_tools_available_with_read_only_gitlab(self, tool_metadata):
        """Test that generic tools are available with read_only_gitlab privilege."""
        registry = ToolsRegistry(
    ...
    def test_generic_tools_follow_preapproval_rules(self, tool_metadata):
        """Test that generic tools follow the same preapproval rules as other read_only_gitlab tools."""
