...
class StartWorkflowRequest(_message.Message):
    __slots__ = ("clientVersion", "workflowID", "workflowDefinition", "goal", "workflowMetadata", "clientCapabilities", "context", "mcpTools", "additional_context", "approval", "additionalTools")
    ...
    ADDITIONALTOOLS_FIELD_NUMBER: _ClassVar[int]
    clientVersion: str
    workflowID: str
    ...
    approval: Approval
    additionalTools: _containers.RepeatedCompositeFieldContainer[Tool]
    def __init__(self, clientVersion: _Optional[str] = ..., workflowID: _Optional[str] = ..., workflowDefinition: _Optional[str] = ..., goal: _Optional[str] = ..., workflowMetadata: _Optional[str] = ..., clientCapabilities: _Optional[_Iterable[str]] = ..., context: _Optional[_Iterable[_Union[ContextElement, _Mapping]]] = ..., mcpTools: _Optional[_Iterable[_Union[McpTool, _Mapping]]] = ..., additional_context: _Optional[_Iterable[_Union[AdditionalContext, _Mapping]]] = ..., approval: _Optional[_Union[Approval, _Mapping]] = ..., additionalTools: _Optional[_Iterable[_Union[Tool, _Mapping]]] = ...) -> None: ...
...
class Action(_message.Message):
    __slots__ = ("requestID", "runCommand", "runHTTPRequest", "runReadFile", "runWriteFile", "runGitCommand", "runEditFile", "newCheckpoint", "listDirectory", "grep", "findFiles", "runMCPTool", "mkdir", "runTool")
    REQUESTID_FIELD_NUMBER: _ClassVar[int]
    ...
    RUNTOOL_FIELD_NUMBER: _ClassVar[int]
    requestID: str
...
class Tool(_message.Message):
    __slots__ = ("name", "source", "description", "inputSchema")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    description: str
    inputSchema: str
    def __init__(self, name: _Optional[str] = ..., source: _Optional[str] = ..., description: _Optional[str] = ..., inputSchema: _Optional[str] = ...) -> None: ...

class RunTool(_message.Message):
    __slots__ = ("name", "args")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ARGS_FIELD_NUMBER: _ClassVar[int]
    name: str
