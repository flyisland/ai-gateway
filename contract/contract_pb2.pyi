...
class ClientEvent(_message.Message):
  ...
  def __init__(self, startRequest: _Optional[_Union[StartWorkflowRequest, _Mapping]] = ...,
               actionResponse: _Optional[_Union[ActionResponse, _Mapping]] = ...) -> None: ...
...
class StartWorkflowRequest(_message.Message):
  __slots__ = ("clientVersion", "workflowID", "workflowDefinition", "goal", "workflowMetadata", "clientCapabilities",
               "context", "mcpTools", "additional_context")
  ...
  def __init__(self, clientVersion: _Optional[str] = ..., workflowID: _Optional[str] = ...,
               workflowDefinition: _Optional[str] = ..., goal: _Optional[str] = ...,
               workflowMetadata: _Optional[str] = ..., clientCapabilities: _Optional[_Iterable[str]] = ...,
               context: _Optional[_Iterable[_Union[ContextElement, _Mapping]]] = ...,
               mcpTools: _Optional[_Iterable[_Union[McpTool, _Mapping]]] = ...,
               additional_context: _Optional[_Iterable[_Union[AdditionalContext, _Mapping]]] = ...) -> None: ...
...
class ActionResponse(_message.Message):
  ...
  def __init__(self, requestID: _Optional[str] = ..., response: _Optional[str] = ...,
               plainTextResponse: _Optional[_Union[PlainTextResponse, _Mapping]] = ...,
               httpResponse: _Optional[_Union[HttpResponse, _Mapping]] = ...) -> None: ...
...
class HttpResponse(_message.Message):
  ...
  def __init__(self, headers: _Optional[_Mapping[str, str]] = ..., statusCode: _Optional[int] = ...,
               body: _Optional[str] = ..., error: _Optional[str] = ...) -> None: ...


class Action(_message.Message):
  __slots__ = ("requestID", "runCommand", "runHTTPRequest", "runReadFile", "runWriteFile", "runGitCommand",
               "runEditFile", "newCheckpoint", "listDirectory", "grep", "findFiles", "runMCPTool")
  REQUESTID_FIELD_NUMBER: _ClassVar[int]
  ...
  def __init__(self, requestID: _Optional[str] = ..., runCommand: _Optional[_Union[RunCommandAction, _Mapping]] = ...,
               ...
               grep: _Optional[_Union[Grep, _Mapping]] = ..., findFiles: _Optional[_Union[FindFiles, _Mapping]] = ...,
               runMCPTool: _Optional[_Union[RunMCPTool, _Mapping]] = ...) -> None: ...
...
class RunCommandAction(_message.Message):
  ...
  def __init__(self, program: _Optional[str] = ..., arguments: _Optional[_Iterable[str]] = ...,
               flags: _Optional[_Iterable[str]] = ...) -> None: ...
...
class EditFile(_message.Message):
  ...
  def __init__(self, filepath: _Optional[str] = ..., oldString: _Optional[str] = ...,
               newString: _Optional[str] = ...) -> None: ...
...
class RunGitCommand(_message.Message):
  ...
  def __init__(self, command: _Optional[str] = ..., arguments: _Optional[str] = ...,
               repository_url: _Optional[str] = ...) -> None: ...
...
class ContextElement(_message.Message):
  ...
  def __init__(self, type: _Optional[_Union[ContextElementType, str]] = ..., name: _Optional[str] = ...,
               contents: _Optional[str] = ...) -> None: ...
...
class NewCheckpoint(_message.Message):
  ...
  def __init__(self, status: _Optional[str] = ..., checkpoint: _Optional[str] = ..., goal: _Optional[str] = ...,
...
class Grep(_message.Message):
  ...
  def __init__(self, search_directory: _Optional[str] = ..., pattern: _Optional[str] = ...,
...
class McpTool(_message.Message):
  ...
  def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ...,
               inputSchema: _Optional[str] = ...) -> None: ...
...
class AdditionalContext(_message.Message):
  ...
  def __init__(self, category: _Optional[str] = ..., id: _Optional[str] = ..., content: _Optional[str] = ...,
               metadata: _Optional[str] = ...) -> None: ...
