...
class StartWorkflowRequest(_message.Message):
  __slots__ = (
  "clientVersion", "workflowID", "workflowDefinition", "goal", "workflowMetadata", "clientCapabilities", "context",
  "mcpTools")
  ...
  def __init__(self, clientVersion: _Optional[str] = ..., workflowID: _Optional[str] = ...,
               ...
               mcpTools: _Optional[_Iterable[_Union[McpTool, _Mapping]]] = ...) -> None: ...
...
class Action(_message.Message):
  __slots__ = (
  "requestID", "runCommand", "runHTTPRequest", "runReadFile", "runWriteFile", "runGitCommand", "runEditFile",
  "newCheckpoint", "listDirectory", "grep", "findFiles", "runMCPTool")
    REQUESTID_FIELD_NUMBER: _ClassVar[int]
