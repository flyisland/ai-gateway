...
class ExtractLinesFromText(DuoBaseTool):
    ...
    description: str = """Extract specific lines of code from a text content.

    The tool extracts lines from a large string content that is separated by '\\n' characters.
    It returns the exact block of code starting from start_line and ending at end_line.
