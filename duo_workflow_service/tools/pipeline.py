...
class GetPipelineErrorsForMergeRequestInput(ProjectResourceInput):
...
class GetPipelineErrorsForMergeRequest(DuoBaseTool):
    name: str = "get_pipeline_errors_for_mr"
    ...
    - Given project_id 13 and merge_request_iid 9, the tool call would be:
        get_pipeline_errors_for_mr(project_id=13, merge_request_iid=9)
    - Given the URL https://gitlab.com/namespace/project/-/merge_requests/103, the tool call would be:
        get_pipeline_errors_for_mr(url="https://gitlab.com/namespace/project/-/merge_requests/103")
    """
    args_schema: Type[BaseModel] = GetPipelineErrorsForMergeRequestInput  # type: ignore
    ...
    def format_display_message(self, args: GetPipelineErrorsForMergeRequestInput) -> str:
        if args.url:
...
#     pipeline_id: int Field(description="Id of the pipeline")
#
#
#
# class GetPipelineErrorsForMergeRequest(DuoBaseTool):
