...
__all__ = ["ComponentRegistry", "register_component", "register_component_factory"]
...
class ComponentRegistry(Mapping):
    ...
    def register_factory(
        ...
        Example:
            Direct call:
            >>> registry = ComponentRegistry.instance()
            >>> registry.register_factory("SupervisorAgentComponent", my_factory_fn)
        """
        if name in self:
            raise KeyError(
...
def register_component_factory(
    ...
    Example:
        Basic usage:
        >>> @register_component_factory("SupervisorAgentComponent")
        ... def my_factory(**kwargs: Any) -> SupervisorAgentComponent:
        ...     return SupervisorAgentComponent(**kwargs)
    """
