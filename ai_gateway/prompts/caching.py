...
# Providers that support default prompt caching via cache_control_injection_points.
CACHE_CONTROL_SUPPORTED_PROVIDERS = frozenset(
    {ModelClassProvider.LITE_LLM, ModelClassProvider.ANTHROPIC}
)
