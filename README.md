...
Agentic Chat can be mocked by setting the environment variable `AIGW_USE_AGENTIC_MOCK=true` (as well as `AIGW_MOCK_MODEL_RESPONSES=true`). You can specify a sequence of responses to simulate a multi-step flow.
